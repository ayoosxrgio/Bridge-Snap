...
export const LEVELS = [
    // ═══ CHAPTER 1: WOOD & BASICS ═══════════════════
    {
        ...
        hint:     "Lay wood planks across the gap to form a road, then add beams underneath for support. The bicycle is light!",
        lesson:   "Every bridge needs a ROAD surface for vehicles and BEAMS for support. Wood planks are your road — beams hold them up!",
    },
    {
        id:       "triangle",
        name:     "TRIANGLE POWER",
